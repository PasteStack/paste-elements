/**
 * Multi-dimension hash-based state manager using #key:value,key:value format.
...
paste['define'](
    ...
    function (module, util, dom, event, guid) {
        'use strict';
        ...
        // region Event Handling
            ...
            genericStateChangeHandler = function genericStateChangeHandler(e) {
                 ...
                 */
                if (e && e.type && e.type.toLowerCase() === POP_STATE && hashchangeSubscription) {
                    hashchangeSubscription['dispose']();
                    hashchangeSubscription = null;
                } else if (e && e.type && e.type.toLowerCase() === HASH_CHANGE && popstateSubscription) {
        ...
        popStateChangeHandler = updateMultiState;
