...
The Apache License includes an explicit patent grant and patent retaliation
clause. The full license text is available in the `LICENSE` file at the root of
this repository.
...
At this time, this project does not bundle third-party source code requiring
additional attribution.

If third-party components are added in the future, required attributions will be
documented here.
